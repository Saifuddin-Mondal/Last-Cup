    ...
    return (
        <div className='footer-wrapper'>
            <div className='footer-container'>
                ...
                <div className='footer-list'>
                    ...
                    <ul className='footer-unorder-list'>
                        ...
                        <li><Link className='footer-one-list' to="#">Privacy Policy</Link></li>
                        <li><Link className='footer-one-list' to="#">Cookie Policy</Link></li>
                    </ul>
                </div>
            ...
            <div className='footer-company'>
                <p>All rights Reserved © Lastup , 2024</p>
